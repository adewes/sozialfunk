...
urlpatterns = patterns('',
    ...
    url(r'^index/(.*)$', views.index),
    url(r'^raw_timeline/?$', views.raw_timeline),
    url(r'^raw_timeline/(.*)$', views.raw_timeline),
    ...
    url(r'^count_click/(\d+)/(.*)$', views.count_click),
    url(r'^js/tweets.js', 'django.views.generic.simple.direct_to_template', {'template': 'tweets/js/tweets.js','mimetype':'text/javascript'},name = 'tweets.js'),
    )
